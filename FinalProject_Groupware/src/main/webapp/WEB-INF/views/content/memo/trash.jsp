...
<div style="display: flex;">
	<div style="margin: auto; padding-left: 3%;">
		...
		<h2 style="margin-bottom: 30px; padding-top: 2%; font-weight: bold;">휴지통</h2>
			...
			<tbody>
				...
				<div class="button">
					<button type="button" class="btn btn-outline-danger"
						...
						style="margin-bottom: 10px; font-weight: bold">휴지통 비우기</button>
				</div>

				<div class="card border-info mb-3" style="max-width: 18rem;">
					<div class="card-header"> 
						 <input type="checkbox" id="check1">
       					 <label for="check1">가족여행 일정짜기</label>
					</div>
					...
					<div class="card-body text-dark">
						...
						<p class="card-text" style="text-align:right;">2025.02.10</p>
					</div>
				</div>
