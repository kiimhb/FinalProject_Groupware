...
--%>
		...
		$("button#register").click(function(){
			...
			// 제목 유효성 검사
			var subject = $("input#schedule_subject").val().trim();
	        if(subject==""){
				alert("제목을 입력하세요."); 
				return;
			}
		...
		//  console.log("색상 => " + $("input#color").val());
			...
			var schedule_joinUserArr = new Array();
			...
			//	console.log(item.innerText.trim());
				/*
					...
					설현(seolh) 
				*/
				schedule_joinUserArr.push(item.innerText.trim());
			});
			
			var schedule_joinuser = schedule_joinUserArr.join(",");
...
<h3>일정 등록</h3>
	...
	<form name="scheduleFrm">
		<table id="schedule" class="table table-bordered">
			...
			<tr>
				<th>제목</th>
				<td><input type="text" id="schedule_subject" name="schedule_subject" class="form-control"/></td>
			</tr>
			...
			<tr>
				<th>공유자</th>
				<td>
				<input type="text" id="schedule_joinuser" class="form-control" placeholder="일정을 공유할 회원명을 입력하세요"/>
