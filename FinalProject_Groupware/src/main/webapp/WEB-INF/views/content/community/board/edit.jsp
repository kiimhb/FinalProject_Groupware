  ...
  $(document).ready(function(){  
	  ...
	  //  <p>&nbsp; &nbsp; &nbsp; &nbsp;</p> 이라고 나온다.
	   ...
	   // alert(content_val);
	      ...
	      // === 글암호 유효성 검사 === 
	      const pw = $("input:password[name='board_pw']").val();	  
	      if(pw == "") {
	    	  alert("글암호를 입력하세요!!");
	    	  return; // 종료
	      }	
	      else {
	    	  if("${requestScope.boardvo.board_pw}" != pw) {
   		...
   		<table style="width: 1024px" class="table table-bordered">
			 <tr>
			    ...
			    <td>
			       ...
			       <input type="text" name="board_name" value="${sessionScope.loginuser.board_name}" readonly>
			    </td>	
   		     </tr>
				...
				<td>
				    <textarea style="width: 100%; height: 612px;" name="board_content" id="content">${requestScope.boardvo.board_content}</textarea>
				</td>
			 </tr>
